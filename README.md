...
- Click "Try it" for the desired endpoint.
...
```
### 3. Send an HTTP request to the API endpoint.
### 4. Parse the JSON format data returned by the API.
The following are some examples of results. You can view specific information through the API documentation.
```
{
    "filters": [
        {
